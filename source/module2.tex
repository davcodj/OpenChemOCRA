...
\paragraph{Atomic Numbers}show the number of protons and electrons in an element. These are then used to order the elements in the periodic table. For example, Li-2 or O-8.
